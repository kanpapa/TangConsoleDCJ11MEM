...
//---------------------------------------------------------------------------
  ...
  wire	 ack_IRQ_tty = (aio_code == AIO_INTACK && iack_level == LV_IRQ0);
...
// monitor sys_clk and ALE_n
  ...
  assign pmod0[0] = CLK_monitor;
  assign pmod0[1] = ALE_monitor;
  assign pmod0[2] = HALT;
  assign pmod0[3] = bus_error;
//  assign pmod0[3] = ~INIT_n;
  assign pmod0[4] = disk_busy;
  assign pmod0[5] = (~sd_miso) | (~sd_mosi);
  assign pmod0[6] = diag_test_failed;
  assign pmod0[7] = rx_data_ready | (~tx_ready);
//  assign pmod0[6] = ~SCTL_n;
//  assign pmod0[7] = ~CONT_n;
